...
cd $APP_NAME/hostapd
   ...
   sed -i -e "s/^#CONFIG_WPS=y/CONFIG_WPS=y/g" $FILE
   sed -i -e "s/^CONFIG_PKCS12=y/#CONFIG_PKCS12=y/g" $FILE
   sed -i -e "s/^CONFIG_IPV6=y/#CONFIG_IPV6=y/g" $FILE
   sed -i -e "s/^#CONFIG_IEEE80211N=y/CONFIG_IEEE80211N=y/g" $FILE
