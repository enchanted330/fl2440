...
#+--------------------------------------------------------------------------------------------
#|Description:  This shell script used to download qrencode code and cross compile it.
...
APP_NAME="qrencode-3.4.4"
PACK_SUFIX="tar.bz2"
DL_ADDR="http://fukuchi.org/works/qrencode//$APP_NAME.$PACK_SUFIX"
