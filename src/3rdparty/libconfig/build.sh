...
#+--------------------------------------------------------------------------------------------
#|Description:  This shell script used to download libconfig source code and cross compile it.
...
APP_NAME="libconfig-1.4.8"
PACK_SUFIX="tar.gz"
DL_ADDR="http://www.hyperrealm.com/libconfig/$APP_NAME.$PACK_SUFIX"
...
cd $APP_NAME
    ...
    ./configure --prefix=$PREFIX_PATH --host=arm-linux
    make
    make install
cd -
