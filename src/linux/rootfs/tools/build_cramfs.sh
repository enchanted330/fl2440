#!/bin/sh
#+--------------------------------------------------------------------------------------------
#|Description: This shell script is used to generate a cramfs for K9F2G08 nandflash
...
set -x
sudo /usr/local/bin/mkcramfs $rootfs_dir $image_name 
